// hacked from https://github.com/psiphi75/ahrs
// vendoring this for now to fix initialization time as i'm not sure what the proper fix is yet
 ...
 */
module.exports = function Madgwick(options) {

    //---------------------------------------------------------------------------------------------------
    // Definitions

    options = options || {};
    var sampleInterval = sampleInterval || 60;
    ...
    return {
        beta: options.beta || 1.0,    // 2 * proportional gain - lower numbers are smoother, but take longer to get to correct attitude.,
